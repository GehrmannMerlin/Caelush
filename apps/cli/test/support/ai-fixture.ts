...
/**
 * The CLI fixture model, expressed as Architecture V2 composition input.
 *
 * Phase 2C replaced the legacy provider-override composition option with the AI core's
 * own seams, so a CLI end-to-end test now composes a real `AISubsystem` from three
 * pieces:
 *
...
/** The descriptor every CLI fixture resolves against. */
...
/** The model metadata authority a CLI fixture composes with. */
...
/** The connection a CLI fixture composes with. */
